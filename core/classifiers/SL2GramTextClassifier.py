...
# -*- coding: utf-8 -*-
#
# File : core.classifiers.SL2GramTextClassifier.py
# Description : 2-gram statistical language text classifier.
...
class SL2GramTextClassifier(TextClassifier):
    ...
    def __init__(self, classes, smoothing, smoothing_param):
        ...
        """
        # Class super class
        super(SL2GramTextClassifier, self).__init__(classes=classes)
    ...
    def __str__(self):
        ...
        :return:
        """
        return "SL2GramTextClassifier(n_classes={}, n_tokens={}, mem_size={}o, " \
    ...
    def _classify(self, x):
        ...
        for token in tokens:
            ...
            # For each class
            for c in self._classes:
                smoothed_value = SL2GramTextClassifier.smooth(self._smoothing, token_probs[c], collection_prob,
                                                              len(tokens),
    ...
    def smooth(smooth_algo, doc_prob, col_prob, doc_length, param):
        ...
        """
        if smooth_algo == "dp":
            return SL2GramTextClassifier.smooth_dirichlet_prior(doc_prob, col_prob, doc_length, param)
        else:
            return SL2GramTextClassifier.smooth_jelinek_mercer(doc_prob, col_prob, param)
        # end if
    # end smooth

# end SL2GramTextClassifier
